	// This part of Softanza is dedicated to Teeba, my daughter, who challenged me,
	// and inspired me!
...
*/
	...
	def ItemsThatAre_NumbersHaving_SameFractionalPartWithoutZeroDot()
		def AllItemsAre_NumbersHaving_SameFractionalPartWithoutZeroDot()	def ContainsOnly_NumbersHaving_SameFractionalPartWithoutZeroDot()
		def SomeItemsAre_NumbersHaving_SameFractionalPartWithoutZeroDot()	def ContainsSome_NumbersHaving_SameFractionalPartWithoutZeroDot()
		def NoItemsAre_NumbersHaving_SameFractionalPartWithoutZeroDot()		def ContainsNo_NumbersHaving_SameFractionalPartWithoutZeroDot()
	def ExcludeItemsThatAre_NumbersHaving_SameFractionalPartWithoutZeroDot()

	def ItemsThatAre_NumbersHaving_SameNumberOfDecimals()
		def AllItemsAre_NumbersHaving_SameNumberOfDecimals()	def ContainsOnly_NumbersHaving_SameNumberOfDecimals()
		def SomeItemsAre_NumbersHaving_SameNumberOfDecimals()	def ContainsSome_NumbersHaving_SameNumberOfDecimals()
		def NoItemsAre_NumbersHaving_SameNumberOfDecimals()	def ContainsNo_NumbersHaving_SameNumberOfDecimals()
	def ExcludeItemsThatAre_NumbersHaving_SameNumberOfDecimals()

	def ItemsThatAre_NumbersHaving_SameMaxNumberOfDigits()
		def AllItemsAre_NumbersHaving_SameMaxNumberOfDigits()	def ContainsOnly_NumbersHaving_SameMaxNumberOfDigits()
		def SomeItemsAre_NumbersHaving_SameMaxNumberOfDigits()	def ContainsSome_NumbersHaving_SameMaxNumberOfDigits()
		def NoItemsAre_NumbersHaving_SameMaxNumberOfDigits()	def ContainsNo_NumbersHaving_SameMaxNumberOfDigits()
	def ExcludeItemsThatAre_NumbersHaving_SameMaxNumberOfDigits()
	...
	def ItemsThatAre_StringsHaving_SameNumberOfLetters()
	...
	def ItemsThatAre_StringsHaving_SameNumberOfChars()
		def AllItemsAre_StringsHaving_SameNumberOfChar()	def ContainsOnly_StringsHaving_SameNumberOfChar()
		def SomeItemsAre_StringsHaving_SameNumberOfChar()	def ContainsSome_StringsHaving_SameNumberOfChar()
		def NoItemsAre_StringsHaving_SameNumberOfChar()		def ContainsNo_StringsHaving_SameNumberOfChar()
	def ExcludeItemsThatAre_StringsHaving_SameNumberOfChar()
...
(...) 
	...
	def ExcludeItemThatAre_StzObjects()
	  ...
	  #----------------------------------#
	 #     NEAR-NATURAL EXPRESSIONS     #
	#----------------------------------#

	def Q(pcNaturalExpression)
/*
		switch low(pcNaturalExpression)
		on "items that are strings alligned to the right"
			call("ItemsThatAre_Strings_Alligned_ToTheRight()")
