...
pub const submodules = [_]Submodule{
    ...
    .{ .parent = "list", .name = "stzListSorter",         .methods = 14, .engine_backed = 4,  .scoping_clean = false, .notes = "Sort/SortDescending engine; SortByExpr pending" },
    .{ .parent = "list", .name = "stzListGetter",         .methods = 35, .engine_backed = 8,  .scoping_clean = false, .notes = "Head/Tail/Section/EveryNthItem engine; bare vars throughout" },
    ...
    .{ .parent = "list", .name = "stzListBounder",        .methods = 22, .engine_backed = 0,  .scoping_clean = false, .notes = "Middle/Bounds/IsWithinBounds Ring-side; pure logic" },
