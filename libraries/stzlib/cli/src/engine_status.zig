...
pub const milestones = [_]Milestone{
    ...
    .{
        ...
        .status = .partial,
        .summary = "Sessions 50+: Ring substr/loop -> Zig engine rewrite. Phase A done 2026-06-12 (b658c08e/fd16e0ef/234f69f1/603499d9): 354 string ERR -> 0; ~300 automated substr->StzReplace/StzFind/StzMid + 20 manual unknowns + 3 trivial Chars-len sites. StzMid defensive (silent on bad input). StzMidToEnd added. FindNextNth/FindPreviousNth/LeadingSubStringCS restored. 51 residual substr calls intentional (byte-walks / LHS-assignment / comments / ambiguous needles). Phase B started 2026-06-12 (2c82e256): count-walk family done -- HowManyOccurrenceOfChar Left/Right Side + NumberOfLeading/TrailingItems now use StzEngineStringCountLeadingChar/CountTrailingChar; StzCodepoint(cChar) primitive added as Unicode-correct ascii() replacement. Phase B remaining: ~113 _aChars_=Chars() walk sites across predicate-walks / find-walks / transform-walks families.",
    },
};
