...
pub const submodules = [_]Submodule{
    ...
    .{ .parent = "list", .name = "stzHashList",           .methods = 63, .engine_backed = 6,  .scoping_clean = false, .notes = "Engine: HasKey/FindKey/NumberOfPairs/Value(Int/Float/String)ByKey via cached @pEngineMap; ~50 methods scoping cleaned (Values/Keys/Find/Replace/Update/Remove/Add/Insert/Copy/Listify/Classify/Classes/Numbers/Strings/Lists/Objects/StzLists/StzHashLists/StzNumbers/StzStrings/StzObjects/Items/FindItem/Klass-family); 5 latent bugs fixed (ValuesAndKeys, ReverseKeysAndValues, UpdateAllPairsWith, FindNthKeyByValue undefined n, FindNthItem.FindItel typo)" },
