...
pub const submodules = [_]Submodule{
    ...
    .{ .parent = "list", .name = "stzListSections",       .methods = 12, .engine_backed = 6,  .scoping_clean = false, .notes = "AntiSections/SlidingWindow engine; rest needs scoping" },
    ...
    .{ .parent = "list", .name = "stzListMover",          .methods = 10, .engine_backed = 3,  .scoping_clean = false, .notes = "Swap/RotateLeft/Right engine" },
