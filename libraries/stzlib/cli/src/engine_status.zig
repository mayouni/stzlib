...
pub const submodules = [_]Submodule{
    ...
    .{ .parent = "list", .name = "stzListOfLists",        .methods = 55, .engine_backed = 0,  .scoping_clean = false, .notes = "~60 methods cleaned (init/Add*/NthList/Find*Lists/Missing*/ItemsAt*/SmallestList*/LargestList*/SizeOf*/Extended*/ExtendTo*/ExtendXT/ExtendToByRepeatingItems*/ExtendToWithItemsIn*/Shrink*/Adjust*/Associate*/Pairify*/Reverse*/IndexCS); 9 latent bugs fixed total (AddMany no-op, NthList :Last fallthrough, FindManyInListsCS dedup discarded, ExtendedXT dropped pItem, ExtendedToByRepeatingItems aResul typo, ExtendToWithItemsIn aConten typo, ShrinkToQ ShrinkTp typo, ShrinkedToUsing/ShrinkedToBy pWith leak, AdjustWith/AdjustXT [@j] should be [@i][@j], AdjustedTo .Conten() typo, Pairify Parify typo)" },
};
