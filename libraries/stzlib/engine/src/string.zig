...
pub const str_xor_cipher_key = encode.str_xor_cipher_key;
pub const str_xor_encrypt_b64 = encode.str_xor_encrypt_b64;
pub const str_xor_decrypt_b64 = encode.str_xor_decrypt_b64;
...
pub const str_script_names = locale.str_script_names;
...
pub const str_jaro = fuzzy.str_jaro;
pub const str_jaro_winkler = fuzzy.str_jaro_winkler;
pub const str_jaccard_similarity = fuzzy.str_jaccard_similarity;
pub const str_soundex = phonetics.str_soundex;
pub const str_metaphone = phonetics.str_metaphone;
pub const str_ngram = textstats.str_ngram;
pub const str_ngram_count = textstats.str_ngram_count;
pub const StzWordFreqResultHandle = textstats.StzWordFreqResultHandle;
pub const str_word_freq = textstats.str_word_freq;
pub const StzWordStreamHandle = textstats.StzWordStreamHandle;
pub const str_word_stream_new = textstats.str_word_stream_new;
pub const str_word_stream_feed = textstats.str_word_stream_feed;
pub const str_word_stream_top = textstats.str_word_stream_top;
pub const str_word_stream_total = textstats.str_word_stream_total;
pub const str_word_stream_distinct = textstats.str_word_stream_distinct;
pub const str_word_stream_free = textstats.str_word_stream_free;
pub const str_char_freq = textstats.str_char_freq;
pub const str_word_ngram_freq = textstats.str_word_ngram_freq;
pub const str_count_word_cs = textstats.str_count_word_cs;
pub const str_numbers_agg = textstats.str_numbers_agg;
pub const str_sentence_stat = textstats.str_sentence_stat;
pub const str_edit_cluster = fuzzy.str_edit_cluster;
pub const str_collocations = textstats.str_collocations;
pub const str_cosine_similarity = textstats.str_cosine_similarity;
pub const str_tfidf_keywords = textstats.str_tfidf_keywords;
pub const stz_word_freq_count = textstats.stz_word_freq_count;
pub const stz_word_freq_word = textstats.stz_word_freq_word;
pub const stz_word_freq_num = textstats.stz_word_freq_num;
pub const stz_word_freq_free = textstats.stz_word_freq_free;
pub const str_char_ngrams = textstats.str_char_ngrams;
pub const str_word_ngrams = textstats.str_word_ngrams;
pub const str_extract_numbers = textstats.str_extract_numbers;
pub const str_extract_emails = textstats.str_extract_emails;
pub const str_extract_words = textstats.str_extract_words;
pub const str_pluralize = textstats.str_pluralize;
pub const str_to_pig_latin = textstats.str_to_pig_latin;
pub const str_to_nato = textstats.str_to_nato;
pub const str_mask_email = textstats.str_mask_email;
