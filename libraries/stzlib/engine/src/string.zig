...
pub const str_find_dupsecutive_chars = find.str_find_dupsecutive_chars;
pub const str_find_dupsecutive_substring = find.str_find_dupsecutive_substring;
...
pub const str_substrings_unique = extract.str_substrings_unique;
