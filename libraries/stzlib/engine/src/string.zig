...
const ta = @import("string/textanalytics.zig");

pub const str_levenshtein = ta.str_levenshtein;
pub const str_hamming_distance = ta.str_hamming_distance;
pub const str_jaro = ta.str_jaro;
pub const str_jaro_winkler = ta.str_jaro_winkler;
pub const str_jaccard_similarity = ta.str_jaccard_similarity;
pub const str_soundex = ta.str_soundex;
pub const str_metaphone = ta.str_metaphone;
pub const str_ngram = ta.str_ngram;
pub const str_ngram_count = ta.str_ngram_count;
pub const StzWordFreqResultHandle = ta.StzWordFreqResultHandle;
pub const str_word_freq = ta.str_word_freq;
pub const StzWordStreamHandle = ta.StzWordStreamHandle;
pub const str_word_stream_new = ta.str_word_stream_new;
pub const str_word_stream_feed = ta.str_word_stream_feed;
pub const str_word_stream_top = ta.str_word_stream_top;
pub const str_word_stream_total = ta.str_word_stream_total;
pub const str_word_stream_distinct = ta.str_word_stream_distinct;
pub const str_word_stream_free = ta.str_word_stream_free;
pub const str_char_freq = ta.str_char_freq;
pub const str_word_ngram_freq = ta.str_word_ngram_freq;
pub const str_count_word_cs = ta.str_count_word_cs;
pub const str_numbers_agg = ta.str_numbers_agg;
pub const str_sentence_stat = ta.str_sentence_stat;
pub const str_edit_cluster = ta.str_edit_cluster;
pub const str_collocations = ta.str_collocations;
pub const str_cosine_similarity = ta.str_cosine_similarity;
pub const str_tfidf_keywords = ta.str_tfidf_keywords;
pub const stz_word_freq_count = ta.stz_word_freq_count;
pub const stz_word_freq_word = ta.stz_word_freq_word;
pub const stz_word_freq_num = ta.stz_word_freq_num;
pub const stz_word_freq_free = ta.stz_word_freq_free;
pub const str_char_ngrams = ta.str_char_ngrams;
pub const str_word_ngrams = ta.str_word_ngrams;
pub const str_extract_numbers = ta.str_extract_numbers;
pub const str_extract_emails = ta.str_extract_emails;
pub const str_extract_words = ta.str_extract_words;
pub const str_pluralize = ta.str_pluralize;
pub const str_to_pig_latin = ta.str_to_pig_latin;
pub const str_to_nato = ta.str_to_nato;
pub const str_mask_email = ta.str_mask_email;
