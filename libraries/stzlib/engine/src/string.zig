...
pub const StzWordStreamHandle = nlp.StzWordStreamHandle;
pub const str_word_stream_new = nlp.str_word_stream_new;
pub const str_word_stream_feed = nlp.str_word_stream_feed;
pub const str_word_stream_top = nlp.str_word_stream_top;
pub const str_word_stream_total = nlp.str_word_stream_total;
pub const str_word_stream_distinct = nlp.str_word_stream_distinct;
pub const str_word_stream_free = nlp.str_word_stream_free;
