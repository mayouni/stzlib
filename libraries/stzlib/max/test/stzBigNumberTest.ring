...
oBig = new stzBigNumber("324987182091876345.078")
...
oBig = new stzBigNumber("795139556375158458500672312034291657065.10336")
	oBig.Divide("876234987333.9876673")
	? oBig.SValue()
...
oBig = new stzBigNumber("124_280_400.68")
	oBig.Divide("2")
	? oBig.SValue()
	#--> 62140200.34
	? oBig.Round()
...
oBig = new stzBigNumber("123_456_789.87")
...
oBig = new stzBigNumber("123_456_789")
	? oBig.RoundedTo(0)
	#--> 123_456_789
...
# stzBigNumber has 3 important criterias regarding rounding:
...
# Create a new stzBigNumber object with a large negative number

oBig = new stzBigNumber("-12_345_567_980_117.8765454")
...
oBig = new stzBigNumber("-123456789")
	? oBig.RoundedTo(0)
	#--> -123456789
...
# This code demonstrates the flexibility of the stzBigNumber class
...
oBig = new stzBigNumber("12_345_549.878546")
...
oBig = new stzBigNumber("-11177875676436736363572788363.98")
? oBig.Spacified()
...
oBig = new stzBigNumber("12345678.67")
...
# stzBigNumber has a nice spacification feature.
# Let's explore it with example

oBig = new stzBigNumber("-12500277113.9887")
...
oBig = new stzBigNumber("12_549_334_289.0987")
...
oBig = new stzBigNumber("999_999_999_999_999_999.999")
oBig.Add("1")
? oBig.SValue()
...
oBig = new stzBigNumber("1_000_000.000")
...
oBig = new stzBigNumber("-12_345.6789")
...
oBig = new stzBigNumber("1.000000")
oBig.Divide("3")
? oBig.SValue()
#--> 0.333333
? oBig.Rounded(5) + NL
...
oBig = new stzBigNumber("-987_654_321.123456789")
oBig.RoundTo(4)
? oBig.SValue()
...
oBig = new stzBigNumber("999.999999")
...
oBig = new stzBigNumber("999.99999")
	oBig.SetPrecision(2)
	? oBig.SValue()
	#--> 1000.00
...
oBig = new stzBigNumber("123.456789")
oBig.SetPrecision(3)
? oBig.SValue()
#--> 123.457
...
# Large Positive Number with Rounding Backpropagation
	...
	oBig = new stzBigNumber("999999999.999999")
	oBig.SetPrecision(5)
	? oBig.SValue()
	#--> 1000000000.00000
...
oBig = new stzBigNumber("-1000.000001")
oBig.SetPrecision(5)
? oBig.SValue()
#--> -1000.00000
...
oBig = new stzBigNumber("123456789.987654321")
? oBig.Spacified()
...
oBig = new stzBigNumber("987654321.123456789")
oBig.SetPrecision(5)
? oBig.SValue()
#--> 987654321.12346
...
oBig = new stzBigNumber("12345.6789")
oBig.SetPrecision(:Max)
? oBig.SValue()
...
oBig = new stzBigNumber("0")
oBig.Add("0")
? oBig.SValue()
#--> 0

oBig = new stzBigNumber("999999999999999999999999999999999999999")
