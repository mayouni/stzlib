...
_aLocaleCountriesXT = [
	...
	//[ "246", 	:Latin_America, 		'', 			'', 			'', 		:spanish, 		'',					'',			'',		''		], # Exists in Qt but removed because it isn't a country
	...
	//[ "258", 	:European_Union, 		"EU", 			"???",			'',		:english, 		:Euro, 					"Cent", 		100,		"🇪🇺"		], # Exists in Qt but removed because it isn't a country
	...
	[ '',		:England,			"EN",			"ENG",			"+44",		:english,		:Pound,					"Penny", 		100,		''		], # Idem. Doesn't exist in Qt (and Unicode) but we add it because some people consider it a country
	[ '',		:Wales,				"WLS",			"WS",			"+44",		:welsh,			:Pound,					"Penny", 		100,		''		], # Idem
	[ '',		:Norther_Ireland,		"NIR",			"NI",			"+44",		:irish,			:Pound,					"Penny",		100,		''		]  # Check: norther or northern?
	//[ '',	:United_nations,		'',			'',			'',		'',			'',					'',			'',		"🇺🇳"		]  # Exists in Qt but removed because it isn't a country
