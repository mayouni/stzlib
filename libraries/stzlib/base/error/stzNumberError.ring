func stzNumberError(pcError)
	_cErrorMsg_ = "in file stzNumber.ring:" + char(10)

	switch pcError

	on :CanNotCreateStzNumberObject
		_cErrorMsg_ += "   What : Can't create the number from the provided value." + char(10)
		_cErrorMsg_ += "   Why  : Value you provided is not in correct form." + char(10)
	...
	on :CanNotCreateDecimalNumber1
		_cErrorMsg_ += "   What : Can not create decimal number!" + char(10)
		_cErrorMsg_ += "   Why  : The number you provided is not valid." + char(10)
	...
	on :CanNotCreateDecimalNumber2
		_cErrorMsg_ += "   What : Can not create decimal number!" + char(10)
		_cErrorMsg_ += "   Why  : The text is not a well-formed number literal." + char(10)
		_cErrorMsg_ += "   Todo : Write the digits either side of the dot -- '0.5', not '.5'."

	on :CanNotCreateNumberFromHexForm
		_cErrorMsg_ += "   What : Can't create the number from a hex form." + char(10)
	...
	on :CanNotCreateNumberFromBinaryForm
		_cErrorMsg_ += "   What : Can't create the number from a binary form." + char(10)
		_cErrorMsg_ += "   Why  : Value you provided to FromBinary() method is not in a valid binary form." + char(10)
	...
	on :CanNotCreateNumberFromOctalForm
		_cErrorMsg_ += "   What : Can't create the number from an octal form." + char(10)
	...
	on :CanNotConvertNumberFromDecimalInThisForm
		_cErrorMsg_ += "   What : Can't convert the number from decimal in the provided form." + char(10)
		_cErrorMsg_ += "   Why  : The form you provided is not a valid decimal form." + char(10)
		_cErrorMsg_ += "   Todo : Provide a number in decimal formed of the digits 0 to 9."

	on :CanNotConvertNumberFromBinaryInThisForm
		_cErrorMsg_ += "   What : Can't convert the number from binary in the provided form." + char(10)
		_cErrorMsg_ += "   Why  : The form you provided is not a valid binary form." + char(10)
	...
	on :CanNotConvertNumberFromOctalInThisForm
		_cErrorMsg_ += "   What : Can't convert the number from octal in the provided form." + char(10)
		_cErrorMsg_ += "   Why  : The form you provided is not a valid octal form." + char(10)
	...
	on :CanNotConvertNumberFromHexInThisForm
		_cErrorMsg_ += "   What : Can't convert the number from hexadecimal in the provided form." + char(10)
		_cErrorMsg_ += "   Why  : The form you provided is not a valid hexadecimal form." + char(10)
	...
	on :UnsupportedNumberConversionTargetForm
		_cErrorMsg_ += "   What : Can't convert the number to its target form." + char(10)
		_cErrorMsg_ += "   Why  : The target form you provided is not supported." + char(10)
	...
	on :UnsupportedNumberConversionSourceForm
		_cErrorMsg_ += "   What : Can't convert the number from its source form." + char(10)
		_cErrorMsg_ += "   Why  : The source form you provided is not supported." + char(10)
	...
	on :CanNotConvertNumberToSpecifiedBase
		_cErrorMsg_ += "   What : Can't convert this number in the specified base." + char(10)
		_cErrorMsg_ += "   Why  : Either the number is not inter or the base you provided is not supported." + char(10)
		_cErrorMsg_ += "   Todo : Provide an integer and a base between 2 and 36 and it will be fine ;)"

	on :CanNotRoundSutchLargeNumber
		_cErrorMsg_ += "   What : Can't round such a large number!" + char(10)
		_cErrorMsg_ += "   Why  : Rounding runs on a Ring double, which is exact only up to 2^53." + char(10)
