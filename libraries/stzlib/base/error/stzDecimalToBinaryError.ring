func stzDecimalToBinaryError(pcError)
	_cErrorMsg_ = "in file stzDecimalToBinary.ring:" + char(10)

	switch pcError
	on :CanNotCreateDecimalNumberFromInvalidString
		_cErrorMsg_ += "   What : Can't create the decimal number." + char(10)
		_cErrorMsg_ += "   Why  : Value you provided for the number is not in a valid decimal form." + char(10)
	...
	on :CanNotCreateDecimalNumberFromInvalidType
		_cErrorMsg_ += "   What : Can't create the decimal number." + char(10)
		_cErrorMsg_ += "   Why  : Value you provided for the number is not in a valid type." + char(10)
