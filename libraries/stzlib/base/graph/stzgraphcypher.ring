#=================================================#
#  stzGraphQuery - OpenCypher-based Query System  #
#  Elegant graph pattern matching for stzGraph    #
#=================================================#

# DESIGN PHILOSOPHY:
# - Native Ring syntax with Cypher query language semantics
# - Fluend chainable actions
# - Full pattern matching support
# - Seamless stzGraph integration
# - OpenCypher import/export

func StzGraphCypherQ(oGraph)
	return new stzGraphCypher(oGraph)

	func CypherQ(oGraph)
		return new stzGraphCypher(oGraph)

class stzGraphCypher
	@oGraph
	@aMatchPatterns = []
	@aWhereConditions = []
	@aReturnFields = []
