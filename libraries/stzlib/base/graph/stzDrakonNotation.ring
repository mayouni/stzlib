...
func StzDrakonNotation()
	...
	_o_.AddKindXT("timer", "timerglyph", "#f3f4f6")
	_o_.AddKindXT("pause", "pauseglyph", "#f3f4f6")
	...
	_o_.AddKindXT("duration", "durationglyph", "#f3f4f6")
	_o_.AddKindXT("par", "parallel", "#f5f3ff")
