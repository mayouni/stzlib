...
#---------------------------------------------------------------------#
#  NOTATION IN A LABEL (DN10) -- MOVED to base/math/stzMathNotation.ring  #
#  on 2026-09-26 (decision 6 of base/math/CHARTER.md). The reader,    #
#  the table and the run-list contract are unchanged; the draw path    #
#  below (_DrawShape's text branch, _MeasureTextAt) stays here.       #
#---------------------------------------------------------------------#
