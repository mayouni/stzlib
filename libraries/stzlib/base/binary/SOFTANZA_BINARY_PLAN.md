...
| 6 | Ring⇄COBOL source translation (stzCobol.ring, doc article) | **DEFER OUT OF PLANE** — a different product (code modernization). stzCobol.ring stays in `future/` untouched; this plane takes only the copybook *data* grammar |
