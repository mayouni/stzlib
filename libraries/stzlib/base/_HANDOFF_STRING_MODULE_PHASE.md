...
commit a *verified asserted* value. Status: 999 tests, blocks 01-215 narrated so
far (01,02,03,05,09-205, 208, 213-215; 128 retired stub; 129/159 deferred
Duplicates-semantics; 147-149 already WF-narrated; no 183, 206-207, 209-212 files
-- empty/merged on extraction). Resume ~216. NOTE: the open-defect catalogue in
...
(box), 103, 104, 111, 114, 115, 116-119 (Shorten), 120, 121. Partials w/ NOTEs:
70_section_out_of_range_raises, 91, 92, 97, 102, 106, 109, 110, 112, 124. The
big open clusters are catalogued in test/string/_AUDIT_DEFECTS.md (Replace-by-many,
Except, bounds + single-repeated-bound, position-anchored XT, contains-in-section,
box-rendering, Shorten/Shortened, W/WXT, plus singletons: Dotless, interpolation
$(), HexUnicodeToUnicode, stzChar.StzType, HexUnicode U+ prefix, Duplicates).
Resume ~136.
