...
commit a *verified asserted* value. Status: 999 tests, blocks 01-125 narrated so
far (01,02,03,05,09-125). Deferred-defect / pending (print-form) blocks: 04, 08,
...
$(), HexUnicodeToUnicode, stzChar.StzType, HexUnicode U+ prefix). Resume ~126.
