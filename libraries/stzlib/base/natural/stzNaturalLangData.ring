...
StzAddNaturalLanguage([
	...
	:semantic_mappings = [
		...
		[:natural = "capitaliser", :semantic = "METHOD_CAPITALIZE"],
		[:natural = "nettoie",     :semantic = "METHOD_TRIM"],
		[:natural = "nettoyer",    :semantic = "METHOD_TRIM"],
		[:natural = "incrémente",  :semantic = "METHOD_INCREMENT"],
		[:natural = "incremente",  :semantic = "METHOD_INCREMENT"],
		[:natural = "décrémente",  :semantic = "METHOD_DECREMENT"],
		[:natural = "decremente",  :semantic = "METHOD_DECREMENT"],
		[:natural = "multiplie",   :semantic = "METHOD_MULTIPLY"],
		[:natural = "divise",      :semantic = "METHOD_DIVIDE"],
