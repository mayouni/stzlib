...
# Loading files related to the GRAPH module
    ...
    load "graph/stzUmlNotation.ring"
    ...
    # a timeline is a scale, and every mark on it is a datum (DN19)
    load "graph/stzTimelineDiagram.ring"
    # a fishbone is an effect, its categories of cause, and the causes on them (DN20)
    load "graph/stzFishboneDiagram.ring"
    # a floor plan is rooms to scale, doors and windows on their walls (DN22)
...
# Loading files related to NATURAL module
    ...
    load "education/stzProject.ring"
    load "education/stzOverlay.ring"
