...
o1 {
    ? PercentileRank(55) 	#--> 50 (55 is between 50 and 60)
    ? PercentileRank(30) 	#--> 25 (30 is at 25th percentile)
    ? PercentileRank(5)  	#--> 0 (below minimum)
    ? PercentileRank(105) 	#--> 100 (above maximum)
}
