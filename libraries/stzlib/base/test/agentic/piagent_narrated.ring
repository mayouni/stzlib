...
oSk.When(func oM { return oM.Fact("stock", "level", "low") })
oSk.Does(func oM {
	oM.Forget("stock", "level", "low")
	oM.Learn("stock", "level", "ordered")
	return 1
})
oSk.VerifiedBy(func oM { return oM.Fact("stock", "level", "ordered") })
...
oGSk.VerifiedBy(func oM { return oM.Fact("stock", "level", "ordered") })
...
oRSk.Does(func oM { oM.Learn("stock", "level", "ordered")  return 1 })
...
s1.Does(func oM { oM.Forget("order","state","placed") oM.Learn("order","state","cooking") return 1 })
s1.VerifiedBy(func oM { return oM.Fact("order","state","cooking") })
s2 = new stzAgentSkill("plate")
s2.When(func oM { return oM.Fact("order", "state", "cooking") })
s2.Does(func oM { oM.Forget("order","state","cooking") oM.Learn("order","state","plated") return 1 })
s2.VerifiedBy(func oM { return oM.Fact("order","state","plated") })
s3 = new stzAgentSkill("serve")
s3.When(func oM { return oM.Fact("order", "state", "plated") })
s3.Does(func oM { oM.Forget("order","state","plated") oM.Learn("order","state","served") return 1 })
s3.VerifiedBy(func oM { return oM.Fact("order","state","served") })
oChain.AddSkill(s1)
oChain.AddSkill(s2)
oChain.AddSkill(s3)
nC = oChain.Pursue()
