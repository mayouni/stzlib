...
o3.AddNodeXTT("p", "Pause",     [ :type = "pause" ])
o3.AddNodeXTT("d", "Duration",  [ :type = "duration" ])
o3.AddNodeXTT("r", "Parallel",  [ :type = "par" ])
o3.AddNodeXTT("e", "End",       [ :type = "end" ])
o3.AddEdge("t","i")  o3.AddEdge("i","a")  o3.AddEdge("a","q")
o3.AddEdgeXT("q","s","yes")  o3.AddEdge("s","m")  o3.AddEdge("m","p")
o3.AddEdge("p","d")  o3.AddEdge("d","r")  o3.AddEdge("r","e")
o3.ToCanvasXT(OPT)
