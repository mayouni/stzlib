...
# abc at 1,9 and def at 5,17, so [1,5,9,17]. Deliberate in commit
# 9f8c1833e, and RULED again 2026-07-19 against the monolithic archive's
# grouped docstring. This test predates both and expected one entry per
# substring; the grouped shape is FindManyZZ.
