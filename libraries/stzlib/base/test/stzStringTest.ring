...
? Q("---سÙ„اÙ…").NumberOfOccurrenceOfCharLeftSide("-")
#--> 3

? Q("سÙ„اÙ…---").NumberOfOccurrenceOfCharRightSide("-")
#--> 3
...
? Q("---سÙ„اÙ…").NumberOfOccurrenceOfCharEndSide("-")
#--> 3

? Q("سÙ„اÙ…---").NumberOfOccurrenceOfCharStartSide("-")
# #--> 3
...
? Dotless("Ù…شÙ…ش ÙˆخÙˆخ ÙˆزÙŠتÙˆÙ†")	#--> Ù…سÙ…س ÙˆحÙˆح ÙˆرٮٮÙˆٮ
...
? Dotless("فÙ„سطÙŠÙ† اÙ„أبÙŠÙ‘ة") 		#--> ٯÙ„سطٮں اÙ„أٮٮÙ‘Ù‡
? Dotless("عاشت اÙ„Ù…Ù‚اÙˆÙ…ة") 		#--> عاسٮ اÙ„Ù…ٯاÙˆÙ…Ù‡
? Dotless("تÙˆÙ†س Ù…عÙƒ ÙŠا غزÙ‘ة")		#--> ٮÙˆٮس Ù…عک ٮا عرÙ‘Ù‡
? Dotless("جÙ…عÙŠة اÙ„خÙŠرات")		#--> حÙ…عٮÙ‡ اÙ„حٮراٮ
? Dotless("أفدÙŠÙƒ برÙˆحÙŠ ÙŠا Ù‚دس") 	#--> أٯدٮک ٮرÙˆحٮ ٮا ٯدس
? Dotless("Ù…شÙ…ش ÙˆخÙˆخ ÙˆزÙŠتÙˆÙ†")		#--> Ù…سÙ…س ÙˆحÙˆح ÙˆرٮٮÙˆٮ
...
? @replace("صباح اÙ„خÙŠر أصدÙ‚ائÙŠ", "خÙŠر", "Ù†Ùˆر")
#o--> صباح اÙ„Ù†Ùˆر أصدÙ‚ائÙŠ
...
? Q("Ù†Ùˆر").AllCharsAre(:Arabic)
#--> TRUE

? Q("Ù†Ùˆر").AllCharsAre(:RightToLeft)
#--> TRUE
...
# of a right-to-left arabic text ("Ù‡ذÙ‡" in the following example),
# you should inverse the orientation and use RemoveFromRight()
# instead...

o1 = new stzString("Ù‡ذÙ‡ اÙ„ÙƒÙ„Ù…ات اÙ„Ù‘تÙŠ سÙˆف تبÙ‚Ù‰")
? o1.NRightCharsAsSubstring(4) #--> "Ù‡ذÙ‡ "

o1.RemoveFromRight("Ù‡ذÙ‡ ")
? o1.Content() #--> "اÙ„ÙƒÙ„Ù…ات اÙ„Ù‘تÙŠ سÙˆف تبÙ‚Ù‰"
...
o1 = new stzString("Ù…Ù† ÙƒاÙ† فÙŠ زÙ…Ù†Ù‡ Ù…Ù† أصحابÙ‡ فÙ‡Ùˆ Ù…Ù† أÙƒبر اÙ„Ù…حظÙˆظÙŠÙ†")
o1.RemoveLast(" Ù…Ù†") # Or o1.RemoveNthOccurrence(:Last, " Ù…Ù†")
? o1.Content()
#--> Gives Ù…Ù† ÙƒاÙ† فÙŠ زÙ…Ù†Ù‡ Ù…Ù† أصحابÙ‡ فÙ‡Ùˆ أÙƒبر اÙ„Ù…حظÙˆظÙŠÙ†
...
# Do you think "ê" and "eÌ‚" are the same?
...
# Quiet-eqality is particularily useful in french where "énoncé" and "Ã‰NONCÃ‰" are the same:
...
o1 = new stzString("__bå’Œå¹³س__a__Ùˆ")
...
o1 = new stzString("__bå’Œå¹³س__a_ÙˆÙˆÙˆ")

? @@( o1.PartsUsingXT(' StzCharQ(@char).Script() ') )
#--> [ "__", "b", "å’Œå¹³", "س", "__", "a", "_", "ÙˆÙˆÙˆ" ]
...
? StzTextQ("abc سÙ„اÙ… abc").ContainsScript(:Arabic)
#--> TRUE

? StzTextQ("abc سÙ„اÙ… abc").ContainsArabicScript()
#--> TRUE

#NOTE: Scripts are now moved from stzString to stzText

# You can use this short form instead of StzTextQ()
? TQ("سÙ„اÙ…").Script() #--> :Arabic
...
o1 = new stzString("Hanine حÙ†ÙŠÙ† is a nice جÙ…ÙŠÙ„ة ÙˆعÙ…رÙ‡ا 7 years-old سÙ†Ùˆات girl!")
...
#	:common		= [ " ", " ", " ", " ", " ", " ", " 7 ", "-", " ", " ", "!" ],
#	:arabic		= [ "حÙ†ÙŠÙ†", "جÙ…ÙŠÙ„ة", "ÙˆعÙ…رÙ‡ا", "سÙ†Ùˆات" ],
#     ]
...
str = "Ù‚ÙŽاÙ„ُÙˆا ادÙ’عُ Ù„ÙŽÙ†ÙŽا رÙŽبÙ‘ÙŽÙƒÙŽ ÙŠُبÙŽÙŠÙ‘ِÙ† Ù„Ù‘ÙŽÙ†ÙŽا Ù…ÙŽا Ù‡ِÙŠÙŽ إِÙ†Ù‘ÙŽ اÙ„Ù’بÙŽÙ‚ÙŽرÙŽ 
تÙŽشÙŽابÙŽÙ‡ÙŽ عÙŽÙ„ÙŽÙŠÙ’Ù†ÙŽا ÙˆÙŽإِÙ†Ù‘ÙŽا إِÙ† شÙŽاءÙŽ اÙ„Ù„Ù‘ÙŽÙ‡ُ Ù„ÙŽÙ…ُÙ‡Ù’تÙŽدُÙˆÙ†ÙŽ (70)
 Ù‚ÙŽاÙ„ÙŽ إِÙ†Ù‘ÙŽÙ‡ُ ÙŠÙŽÙ‚ُÙˆÙ„ُ إِÙ†Ù‘ÙŽÙ‡ÙŽا بÙŽÙ‚ÙŽرÙŽةÙŒ Ù„Ù‘ÙŽا ذÙŽÙ„ُÙˆÙ„ÙŒ تُثِÙŠرُ اÙ„Ù’أÙŽرÙ’ضÙŽ ÙˆÙŽÙ„ÙŽا
 تÙŽسÙ’Ù‚ِÙŠ اÙ„Ù’حÙŽرÙ’ثÙŽ Ù…ُسÙŽÙ„Ù‘ÙŽÙ…ÙŽةÙŒ Ù„Ù‘ÙŽا شِÙŠÙŽةÙŽ فِÙŠÙ‡ÙŽا Ûš Ù‚ÙŽاÙ„ُÙˆا اÙ„Ù’آÙ†ÙŽ 
جِئÙ’تÙŽ بِاÙ„Ù’حÙŽÙ‚Ù‘ِ Ûš فÙŽذÙŽبÙŽحُÙˆÙ‡ÙŽا ÙˆÙŽÙ…ÙŽا ÙƒÙŽادُÙˆا ÙŠÙŽفÙ’عÙŽÙ„ُÙˆÙ†ÙŽ (71)
 ÙˆÙŽÙ‚ÙŽدÙ’ ÙƒÙŽاÙ†ÙŽ فÙŽرِÙŠÙ‚ÙŒ Ù…Ù‘ِÙ†Ù’Ù‡ُÙ…Ù’ ÙŠÙŽسÙ’Ù…ÙŽعُÙˆÙ†ÙŽ ÙƒÙŽÙ„ÙŽاÙ…ÙŽ اÙ„Ù„Ù‘ÙŽÙ‡ِ ثُÙ…Ù‘ÙŽ ÙŠُحÙŽرÙ‘ِفُÙˆÙ†ÙŽÙ‡ُ
 Ù…ِÙ† بÙŽعÙ’دِ Ù…ÙŽا عÙŽÙ‚ÙŽÙ„ُÙˆÙ‡ُ ÙˆÙŽÙ‡ُÙ…Ù’ ÙŠÙŽعÙ’Ù„ÙŽÙ…ُÙˆÙ†ÙŽ (75)
 ÙˆÙŽإِذÙŽا Ù„ÙŽÙ‚ُÙˆا اÙ„Ù‘ÙŽذِÙŠÙ†ÙŽ آÙ…ÙŽÙ†ُÙˆا Ù‚ÙŽاÙ„ُÙˆا آÙ…ÙŽÙ†Ù‘ÙŽا
 ÙˆÙŽإِذÙŽا خÙŽÙ„ÙŽا بÙŽعÙ’ضُÙ‡ُÙ…Ù’ إِÙ„ÙŽÙ‰ٰ بÙŽعÙ’ضٍ Ù‚ÙŽاÙ„ُÙˆا أÙŽتُحÙŽدÙ‘ِثُÙˆÙ†ÙŽÙ‡ُÙ…
 بِÙ…ÙŽا فÙŽتÙŽحÙŽ اÙ„Ù„Ù‘ÙŽÙ‡ُ عÙŽÙ„ÙŽÙŠÙ’ÙƒُÙ…Ù’ Ù„ِÙŠُحÙŽاجÙ‘ُÙˆÙƒُÙ… بِÙ‡ِ عِÙ†دÙŽ رÙŽبÙ‘ِÙƒُÙ…Ù’ Ûš أÙŽفÙŽÙ„ÙŽا تÙŽعÙ’Ù‚ِÙ„ُÙˆÙ†ÙŽ  (76)  
"
...
o1 = new stzString("Ù‡ذا Ù†صÙ‘ Ù„ا ÙŠشبÙ‡ أÙŠÙ‘ Ù†صÙ‘ ÙˆÙŠا Ù„Ù‡ Ù…Ù† Ù†صÙ‘ ÙŠا صدÙŠÙ‚ÙŠ")
? o1.FindAll("Ù†صÙ‘")
#--> [5, 21, 35]
...
o1 = new stzString("ring language isسÙ„اÙ…  a nice language")
...
o1 = new stzString("سÙ„اÙ… عÙ„ÙŠÙƒÙ… ÙŠاأÙ‡Ù„ Ù…صر hello اÙ„ÙƒراÙ…")
...
#--> [ "ring language is", "سÙ„اÙ…", "  a nice language" ]
...
#o--> [ "سÙ„اÙ…", " ", "عÙ„ÙŠÙƒÙ…", " ", "ÙŠاأÙ‡Ù„", " ", "Ù…صر", " hello ", "اÙ„ÙƒراÙ…" ]

? @@( o1.Parts2UsingXT( 'StzCharQ(@char).Orientation()') )
#o--> [
#o	[ "سÙ„اÙ…", "righttoleft" ],
#o	[ " ", "lefttoright" ],
#o	[ "عÙ„ÙŠÙƒÙ…", "righttoleft" ],
#o	[ " ", "lefttoright" ],
#o	[ "ÙŠاأÙ‡Ù„", "righttoleft" ],
#o	[ " ", "lefttoright" ],
#o	[ "Ù…صر", "righttoleft" ],
#	[ " hello ", "lefttoright" ],
#o	[ "اÙ„ÙƒراÙ…", "righttoleft" ]
# ]
...
o1 = new stzString("سÙ„اÙ… Ù„أÙ‡Ù„ Ù…صر اÙ„ÙƒراÙ…")
...
o1 = new stzString("بسÙ… اÙ„Ù„Ù‡ اÙ„رÙ‘حÙ…Ù† اÙ„رÙ‘حÙŠÙ…")
? o1.IsBoundedBy(["بسÙ…", "اÙ„رÙ‘حÙŠÙ…"])
#--> TRUE
...
? @@( o1.FindTheseBounds("بسÙ…", "اÙ„رÙ‘حÙŠÙ…") )
#--> [ 1, 18 ]

? @@( o1.FindBoundedBy([ "بسÙ…", "اÙ„رÙ‘حÙŠÙ…" ]) ) + NL
#--> [ 4 ]

#--

? @@( o1.FindTheseBoundsZZ("بسÙ…", "اÙ„رÙ‘حÙŠÙ…") )
#--> [ [ 1, 3 ], [ 18, 24 ] ]

? @@( o1.FindBoundedByZZ([ "بسÙ…", "اÙ„رÙ‘حÙŠÙ…" ]) )
#--> [ [ 4, 17 ] ]
...
o1 = new stzString("Ù…ÙŽÙ†Ù’صُÙˆرِÙŠÙ‘ÙŽاتُُ")
...
o1 = new stzString("سÙ„سبÙŠÙ„")

? o1.IsMadeOf([ "ب", "Ù„", "س", "ÙŠ" ])
#--> TRUE

? o1.IsMadeOf([ "ب", "Ù„", "س", "ÙŠ", "ج" ])
#--> FALSE

? o1.IsMadeOfSome([ "ب", "Ù„", "س", "ÙŠ", "m" ])
#--> TRUE
...
o1 = new stzString("اسÙ…ÙŠ Ù‡Ùˆ فÙ„اÙ†ةØŒ Ù‚Ù„ت Ù„Ùƒ فÙ„اÙ†ة! أÙˆÙŽ Ù„Ù… ÙŠعجبÙƒ أÙ† ÙŠÙƒÙˆÙ† اسÙ…ÙŠ فÙ„اÙ†ةØŸ")
o1.ReplaceAll("فÙ„اÙ†ة", "فÙ„سطÙŠÙ†")
? o1.Content()
o#--> اسÙ…ÙŠ Ù‡Ùˆ فÙ„سطÙŠÙ†ØŒ Ù‚Ù„ت Ù„Ùƒ فÙ„سطÙŠÙ†! أÙˆÙŽ Ù„Ù… ÙŠعجبÙƒ أÙ† ÙŠÙƒÙˆÙ† اسÙ…ÙŠ فÙ„سطÙŠÙ†ØŸ
...
#		str += "اÙ„سÙ‘Ù„اÙ… عÙ„ÙŠÙƒÙ… ÙˆرحÙ…ة اÙ„Ù„Ù‡"
#	next
#	? "Finished"
#
#	? ElapsedTime() + NL
...
# While in Softanza, using  Concatenate(), this take about 4 seconds:
	...
	acList = []
	for i = 1 to 1_000_000
		acList + "اÙ„سÙ‘Ù„اÙ… عÙ„ÙŠÙƒÙ… ÙˆرحÙ…ة اÙ„Ù„Ù‡"
	next
...
#	cStr = ""
#	for i = 1 to 1_000_000
#		cStr += "اÙ„سÙ‘Ù„اÙ… عÙ„ÙŠÙƒÙ… ÙˆرحÙ…ة اÙ„Ù„Ù‡"
#	next
#
#	? ElapsedTime() + NL
#	#--> 45.63 second(s)
...
# does the job in less then 4 seconds:
	...
	for i = 1 to 1_000_000
		aListOfStr + "اÙ„سÙ‘Ù„اÙ… عÙ„ÙŠÙƒÙ… ÙˆرحÙ…ة اÙ„Ù„Ù‡"
	next
