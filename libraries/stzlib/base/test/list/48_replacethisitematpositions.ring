...
# else. (The commented CheckParamOff() is a speed knob, in large loops, not behaviour.)
#
...
# Executed in 0.16 second(s) before
#NOTE : In large loops, turn CheckParamsOff() to get 0.03
