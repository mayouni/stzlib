# Narrative
# --------
# Finding a value inside a large numeric range with the global StzFind().
#
# StzFind(1:299_000, 40_000) searches the contiguous integer range from 1 to
...
# itself, so the answer is 40000. This also shows StzFind() handling a range
