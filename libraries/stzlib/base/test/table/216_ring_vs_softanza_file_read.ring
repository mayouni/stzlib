...
# The file "../_data/tabdata.csv" contains this:
...
str = read("../_data/tabdata.csv") # EOLs (End-Of-File chars are platform specific)
...
oFile = new stzFileXT("../_data/tabdata.csv", :ReadOnly)  # stzFile handles EOLs uniformly
