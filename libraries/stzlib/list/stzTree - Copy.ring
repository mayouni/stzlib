...
class stzTree from stzList
	...
	def ReplaceLeafsCS(pNewLeaf, pCaseSensitive)
		...
		def ReplaceItemsCS(pNewItem, pCaseSensitive)
			This.ReplaceAllLeafsCS(pNewItem, pCaseSensitive)
	
		def ReplaceAllLeafsCS(pNewLeaf, pCaseSensitive)
			This.ReplaceLeafsWithCS(pNewLeaf, pCaseSensitive)
	
		def ReplaceAllItemsCS(pNewItem, pCaseSensitive)
			This.ReplaceLeafsCS(pNewItem, pCaseSensitive)
	
	def ReplaceLeafs(pNewLeaf)
		This.ReplaceLeafsCS(pNewLeaf, _TRUE_)
